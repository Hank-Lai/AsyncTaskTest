...
import com.example.asynctasktest.Sport;
import com.example.asynctasktest.SportAdapter;
import com.example.asynctasktest.utils.CommonUtils;
import com.example.asynctasktest.utils.DividerItemDecoration;
...
public class RecyclerActivity extends AppCompatActivity implements SportAdapter.Callback {
    ...
    private void prepareDemoContent() {
        CommonUtils.showLoading(RecyclerActivity.this);
